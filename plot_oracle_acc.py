...
if __name__ == '__main__':
    ...
    space_list = np.array(results['space_list'])
    ...
    cutoff_count_sketch_predictions = np.array(results['cutoff_count_sketch_predictions'])
    ...
    # plt.savefig('loss_per_partition')


    # sort the estimates by true freuqency 
    sort = pred_counts.argsort()
