...
from greedy import count_min, cutoff_countmin, cutoff_lookup, cutoff_countmin_wscore, order_y_wkey_list
...
def run_ccm_wscore(y, scores, score_cutoff, n_cm_buckets, n_hashes, name):
    start_t = time.time()
...
if __name__ == '__main__':
    ...
    if args.perfect_order:
        name = 'cutoff_cmin_param_perfect'
    elif args.lookup_data:
        name = 'lookup_table'
    else:
        name = 'cutoff_cmin_param'
